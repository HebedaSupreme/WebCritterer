...
public class CrittererEat
    //Also there is a little problem worth fixing later...note to self.....there is a java.lang.NullPointerException when the critterer grabs "0" links
{
    ...
    public boolean critter(String url) {
        try {
            ...
            if (connection.response().statusCode() == 200) {
                ...
                //PrintStream o = new PrintStream(titles+".txt");
                System.out.println(titles+".txt");
                //System.setOut(o);
                System.out.println("\n**BOOOOOPPP** Visiting Page " + url);
